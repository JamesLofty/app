...
app_ui = ui.page_navbar(
    ...
    ui.h2("Vertical Rouse concentration profiles"),

    ui.card(
        ui.card_header("Rouse profile plot"),
    ...
    title="Plastic Rouse Profile Explorer",
)
...
def server(input: Inputs, output: Outputs, session: Session):
    ...
    @render.plot(alt="Direction-aware vertical Rouse concentration profile plot")
    def profile_plot():
