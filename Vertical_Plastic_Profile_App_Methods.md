...
- **Explorer** focuses on comparing predicted vertical concentration profiles for synthetic microplastics and optional macroplastic groups or items.
...
**Macroplastics: total** and also reports the selected classes separately.
...
<div style="text-align:center; font-weight:600; margin:0.6rem 0;">
Correction factor = 1 / F<sub>median</sub>
</div>

The corrected depth-averaged concentration is:

<div style="text-align:center; font-weight:600; margin:0.6rem 0;">
C<sub>depth-avg</sub> = C<sub>measured</sub> / F<sub>median</sub>
</div>
...
<div style="text-align:center; font-weight:600; margin:0.6rem 0;">
C<sub>depth-avg,j</sub> = C<sub>measured,j</sub> / F<sub>j</sub>
</div>
...
- **F<sub>median</sub> = 0.50** gives correction factor **2**
- **F<sub>median</sub> = 0.25** gives correction factor **4**
- **F<sub>median</sub> = 0.10** gives correction factor **10**
- **F<sub>median</sub> = 0.05** gives correction factor **20**
